...
Host egress verification and the external task-runner staging decision are
deployment gates even when runtime readiness passes. Complete the isolated
backup/restore drill and record editor access policy before activation.
